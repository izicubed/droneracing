...
const scheduleDays: Record<DayKey, ScheduleDay> = {
  day1: {
    ...
    rows: [
      ...
      { kind: "parallel", time: "14:00 – 16:00",
        left: {
          emoji: "🎯",
          ru: { title: "Квалификация — Open Class", tags: t("ru", "qual", "oc"),
            desc: "Первый зачётный этап Open Class. Каждый пилот выполняет несколько квалификационных раундов, лучшее время идёт в зачёт. По результатам формируется сетка отборочных раундов второго дня." },
          en: { title: "Qualification — Open Class", tags: t("en", "qual", "oc"),
            desc: "First scored stage for Open Class. Each pilot completes multiple qualification rounds; best times feed into the standings. Results seed the Day 2 elimination bracket." },
        },
        right: {
          emoji: "🐝",
      ...
      { kind: "parallel", time: "16:00 – 17:30",
        left: {
          emoji: "🎯",
          ru: { title: "Квалификация — Open Class (продолжение)", tags: t("ru", "qual", "oc"),
            desc: "Продолжение квалификационных раундов Open Class. Дополнительные попытки для улучшения позиции в зачёте. По окончании — предварительные итоги дня." },
          en: { title: "Qualification — Open Class (cont.)", tags: t("en", "qual", "oc"),
            desc: "Continuation of Open Class qualification. Additional attempts for pilots to improve standings. Preliminary day results announced at the end." },
        },
        right: {
          emoji: "🐝",
          ru: { title: "Квалификация — Tiny Whoop (продолжение)", tags: t("ru", "qual", "whoop"),
            desc: "Продолжение квалификационных раундов Tiny Whoop. Пилоты получают дополнительные попытки для улучшения результата." },
          en: { title: "Qualification — Tiny Whoop (cont.)", tags: t("en", "qual", "whoop"),
            desc: "Continuation of Tiny Whoop qualification rounds. Pilots get additional attempts to improve their standing." },
        },
      },
