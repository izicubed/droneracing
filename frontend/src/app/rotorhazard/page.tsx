...
const FAQ = [
  ...
  },
  {
    ...
    a: "До 8 пилотов в одном заезде в стандартной конфигурации. Общее число пилотов на событии не ограничено. Количество одновременно отслеживаемых пилотов зависит от числа приёмных модулей RX5808 в системе.",
  },
  {
