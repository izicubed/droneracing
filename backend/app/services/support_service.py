...
_RH_VS_NH_ANSWER = (
    ...
    "Её не нужно паять, достаточно подключить Raspberry Pi и приёмники. Плюс итоговая сборка обычно получается более компактной.\n\n"
    "Если коротко: RotorHazard дешевле, если готов собирать сам. "
    "NuclearHazard удобнее, если хочешь готовое и более компактное решение. "
